...
export const uptdOptions = (): SelectOption[] => {
  ...
  if (process.env.MODE === "uptd") {
    ...
    uptdOptions = [{ value: `uptd${n}`, label: `UPTD ${n}` }];
  } else {
    uptdOptions = [
      ...
      kegiatanOptions = [
        {
          ...
          options: [
            ...
            {
              value: KEGIATAN.KEMANTAPAN_JALAN,
              label: "Survei Kondisi Kemantapan Jalan",
            },
            {
              value: KEGIATAN.KERUSAKAN_JALAN_TITIK,
              label: "Kerusakan Jalan (Titik)",
            },
            {
              value: KEGIATAN.KONDISI_JALAN,
              label: "Survei Kondisi Jalan dengan Roaddroid",
            },
            {
              value: KEGIATAN.KONDISI_JALAN_TITIK,
              label: "Survei Kondisi Jalan (Titik Roaddroid)",
            },
          ],
        },
        {
        ...
        {
          label: "Integrasi BIM",
          options: [{ value: KEGIATAN.LEGER, label: "Leger Jalan" }],
        },
        {
          label: "Kebencanaan",
          options: [
            ...
            {
              value: KEGIATAN.TITIK_RAWAN_BENCANA,
              label: "Titik Rawan Bencana",
            },
      ...
      kegiatanOptions = [
        {
          ...
          options: [
            { value: KEGIATAN.RUAS_JALAN, label: "Ruas Jalan" },
            {
              value: KEGIATAN.KEMANTAPAN_JALAN_MASYARAKAT,
